...
hyperfine --warmup 3 --runs 5 --export-json ../results/single_thread_performance.json \
    'freyja covariants ../bygul/jn.1.1.trimmed.bam --annot ../NC_045512_Hu-1.gff --output ../results/freyja_covariants.tsv --min_quality 0 --min_count 0 --threads 1' \
    ...
    'covar -i ../bygul/jn.1.1.trimmed.bam -r ../NC_045512_Hu-1.fasta -a ../NC_045512_Hu-1.gff -o ../results/covar.tsv --threads 1'