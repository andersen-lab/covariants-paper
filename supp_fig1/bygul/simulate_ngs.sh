...
#declare -a read_counts=("10000" "50000" "100000") # reads per amplicon
declare -a read_counts=("1000") # reads per amplicon
...
for read_count in "${read_counts[@]}"; do
    ...
    lofreq call --no-default-filter -A -B -a 1 -b 1 -f ../NC_045512_Hu-1.fasta jn.1.1_${read_count}_merged.trimmed.bam  -o jn.1.1_${read_count}_merged.trimmed.vcf # relaxed settings for testing
